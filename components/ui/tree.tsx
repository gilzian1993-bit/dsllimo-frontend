...
const TreeNode: FunctionComponent<TreeNodeProps> = ({
 ...
 "before:absolute before:left-2 rtl:before:right-2 before:top-0 before:h-[calc(100%-23px)] before:w-[2px] before:bg-secondary before:rounded before:z-[-1]":
 ...
 {hasChildren && (
 <div className="relative ml-5 rtl:mr-5">
 {expandedKeys.includes(id) &&
 children.map((child) => (
 <React.Fragment key={child.id}>
 {showLine && (
 <span className="absolute -left-3 rtl:right-3 mt-1.5">
