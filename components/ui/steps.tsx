...
const Step = React.forwardRef<HTMLLIElement, StepProps>(
 ...
 "before:left-[44px] before:w-[calc(100%-44px)] rtl:before:right-[44px]":
 gap && !alternativeLabel,
 "before:left-1/2 rtl:before:right-1/2 ": alternativeLabel && !gap,
 "before:left-[calc(50%+33px)] rtl:before:right-[calc(50%+33px)] before:w-[calc(100%-60px)]":
